"""Train DINOv2-small on ACRIMA, ORIGA, and RIM-ONE independently.
...
def train_on_dataset(dataset_name: str, args: argparse.Namespace) -> None:
    ...
    log_name = f"dinov2_small_{dataset_name}"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train DINOv2-small independently on ACRIMA, ORIGA, and RIM-ONE"
    )
